...
class ExpertAgent:
    ...
    Legacy note: this agent validates the older IntermediateRepresentation
    dataclass model. The active multi-candidate UML pipeline uses dictionary
    artifacts in graph.candidate and does not use this class for self-repair.
    """
